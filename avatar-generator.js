document.getElementById("gender1").addEventListener("click", function (){
  ...
  function avatarGenerate(data){
    ...
    if(data[3]!=""){
      imgBody.src = "/assets/media/CharacterMan/"+data[3]+".png";
      ...
      if(data[4]=="eyebrows_1"){
        imgEyebrows.src = "/assets/media/CharacterMan/sample1"+data[5]+".png";
        ctxEyebrows.drawImage(imgEyebrows, 0, 0);
      }else if(data[4]=="eyebrows_2"){
        imgEyebrows.src = "/assets/media/CharacterMan/sample2"+data[5]+".png";
        ctxEyebrows.drawImage(imgEyebrows, 0, 0);
      }else if(data[4]=="eyebrows_3"){
        imgEyebrows.src = "/assets/media/CharacterMan/sample3"+data[5]+".png";
        ctxEyebrows.drawImage(imgEyebrows, 0, 0);
      }else if(data[4]=="eyebrows_4"){
        imgEyebrows.src = "/assets/media/CharacterMan/sample4"+data[5]+".png";
        ctxEyebrows.drawImage(imgEyebrows, 0, 0);
      }else if(data[4]=="eyebrows_5"){
        imgEyebrows.src = "/assets/media/CharacterMan/sample5"+data[5]+".png";
        ctxEyebrows.drawImage(imgEyebrows, 0, 0);
      }else if(data[4]=="eyebrows_6"){
        imgEyebrows.src = "/assets/media/CharacterMan/sample6"+data[5]+".png";
        ctxEyebrows.drawImage(imgEyebrows, 0, 0);
      }
          ...
          if(data[6]=="eye_1"){
            imgEye.src = "/assets/media/CharacterMan/sample1"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_2"){
            imgEye.src = "/assets/media/CharacterMan/sample2"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_3"){
            imgEye.src = "/assets/media/CharacterMan/sample3"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_4"){
            imgEye.src = "/assets/media/CharacterMan/sample4"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_5"){
            imgEye.src = "/assets/media/CharacterMan/sample5"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_6"){
            imgEye.src = "/assets/media/CharacterMan/sample6"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_7"){
            imgEye.src = "/assets/media/CharacterMan/sample7"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_8"){
            imgEye.src = "/assets/media/CharacterMan/sample8"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }
          else if(data[6]=="eye_9"){
            imgEye.src = "/assets/media/CharacterMan/sample9"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }
          else if(data[6]=="eye_10"){
            imgEye.src = "/assets/media/CharacterMan/sample10"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }
          ...
          imgMouth.src = "/assets/media/CharacterMan/sample"+data[8]+".png";
          ctxMouth.drawImage(imgMouth, 0, 0);
                 
       // Accesories create
       let ctxAcc= canvas.getContext("2d");
       let imgAcc= new Image();
       imgAcc.src = "/assets/media/CharacterMan/sample"+data[20]+".png";
       ctxAcc.drawImage(imgAcc, 0, 0);
            ...
            if(data[9]=="hair_1"){
              imgHair.src = "/assets/media/CharacterMan/sample1hairC_1.gif";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_2"){
              imgHair.src = "/assets/media/CharacterMan/sample2"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_3"){
              imgHair.src = "/assets/media/CharacterMan/sample3"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_4"){
              imgHair.src = "/assets/media/CharacterMan/sample4"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_5"){
              imgHair.src = "/assets/media/CharacterMan/sample5"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_6"){
              imgHair.src = "/assets/media/CharacterMan/sample6"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_7"){
              imgHair.src = "/assets/media/CharacterMan/sample7"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_8"){
              imgHair.src = "/assets/media/CharacterMan/sample8"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_9"){
              imgHair.src = "/assets/media/CharacterMan/sample9"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_10"){
              imgHair.src = "/assets/media/CharacterMan/sample10"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_11"){
              imgHair.src = "/assets/media/CharacterMan/sample11"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_12"){
              imgHair.src = "/assets/media/CharacterMan/sample12"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_13"){
              imgHair.src = "/assets/media/CharacterMan/sample13"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }else if(data[9]=="hair_14"){
              imgHair.src = "/assets/media/CharacterMan/sample14"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }
            else if(data[9]=="hair_15"){
              imgHair.src = "/assets/media/CharacterMan/sample15"+data[10]+".png";
              ctxHair.drawImage(imgHair, 0, 0);
            }
            ...
            if(data[16]=="pant_1"){
              imgPant.src = "/assets/media/CharacterMan/sample1"+data[17]+".png";
              ctxPant.drawImage(imgPant, 0, 0);
            }else if(data[16]=="pant_2"){
              imgPant.src = "/assets/media/CharacterMan/sample2"+data[17]+".png";
              ctxPant.drawImage(imgPant, 0, 0);
            }else if(data[16]=="pant_3"){
              imgPant.src = "/assets/media/CharacterMan/sample3"+data[17]+".png";
              ctxPant.drawImage(imgPant, 0, 0);
            }else if(data[16]=="pant_4"){
              imgPant.src = "/assets/media/CharacterMan/sample4"+data[17]+".png";
              ctxPant.drawImage(imgPant, 0, 0);
            }else if(data[16]=="pant_5"){
              imgPant.src = "/assets/media/CharacterMan/sample5"+data[17]+".png";
              ctxPant.drawImage(imgPant, 0, 0);
            }
            ...
            if(data[18]=="shoes_1"){
              imgShoes.src = "/assets/media/CharacterMan/sample1"+data[19]+".png";
              ctxShoes.drawImage(imgShoes, 0, 0);
            }else if(data[18]=="shoes_2"){
              imgShoes.src = "/assets/media/CharacterMan/sample2"+data[19]+".png";
              ctxShoes.drawImage(imgShoes, 0, 0);
            }else if(data[18]=="shoes_3"){
              imgShoes.src = "/assets/media/CharacterMan/sample3"+data[19]+".png";
              ctxShoes.drawImage(imgShoes, 0, 0);
            }
            ...
            if(data[13]=="shirt_1"){
              imgShirt.src = "/assets/media/CharacterMan/sample1"+data[14]+".png";
              ctxShirt.drawImage(imgShirt, 0, 0);
            }else if(data[13]=="shirt_2"){
              imgShirt.src = "/assets/media/CharacterMan/sample2"+data[14]+".png";
              ctxShirt.drawImage(imgShirt, 0, 0);
            }else if(data[13]=="shirt_3"){
              imgShirt.src = "/assets/media/CharacterMan/sample3"+data[14]+".png";
              ctxShirt.drawImage(imgShirt, 0, 0);
            }else if(data[13]=="shirt_4"){
              imgShirt.src = "/assets/media/CharacterMan/sample4"+data[14]+".png";
              ctxShirt.drawImage(imgShirt, 0, 0);
            }else if(data[13]=="shirt_5"){
              imgShirt.src = "/assets/media/CharacterMan/sample5"+data[14]+".png";
              ctxShirt.drawImage(imgShirt, 0, 0);
            }else if(data[13]=="shirt_6"){
              imgShirt.src = "/assets/media/CharacterMan/sample6"+data[14]+".png";
              ctxShirt.drawImage(imgShirt, 0, 0);
            }
               ...
               let imgPrint = new Image();
                 ...
                 imgPrint.src = "/assets/media/CharacterMan/sample1"+data[15]+".png";
                 ctxPrint.drawImage(imgPrint, 0, 0);
                      ...
                      if(data[11]=="beard_1"){
                        imgBeard.src = "/assets/media/CharacterMan/sample1beardC_1.gif";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_2"){
                        imgBeard.src = "/assets/media/CharacterMan/sample2"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_3"){
                        imgBeard.src = "/assets/media/CharacterMan/sample3"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_4"){
                        imgBeard.src = "/assets/media/CharacterMan/sample4"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_5"){
                        imgBeard.src = "/assets/media/CharacterMan/sample5"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_6"){
                        imgBeard.src = "/assets/media/CharacterMan/sample6"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_7"){
                        imgBeard.src = "/assets/media/CharacterMan/sample7"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_8"){
                        imgBeard.src = "/assets/media/CharacterMan/sample8"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }else if(data[11]=="beard_9"){
                        imgBeard.src = "/assets/media/CharacterMan/sample9"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }
                      else if(data[11]=="beard_10"){
                        imgBeard.src = "/assets/media/CharacterMan/sample10"+data[12]+".png";
                        ctxBeard.drawImage(imgBeard, 0, 0);
                      }
  ...
  function avatarGenerateW(data){
    ...
    textctx.fillText(data[1], 170, 510);
     ...
     let imgBody = new Image();
     if(data[3]!=""){
       imgBody.src = "/assets/media/CharacterWoman/"+data[3]+".png";
       ctxBody.drawImage(imgBody, 0, 0);
     }
     ...
     let imgEyebrows = new Image();
     if(data[4]=="eyebrows_1"){
       imgEyebrows.src = "/assets/media/CharacterWoman/sample1"+data[5]+".png";
       ctxEyebrows.drawImage(imgEyebrows, 0, 0);
     }else if(data[4]=="eyebrows_2"){
       imgEyebrows.src = "/assets/media/CharacterWoman/sample2"+data[5]+".png";
       ctxEyebrows.drawImage(imgEyebrows, 0, 0);
     }else if(data[4]=="eyebrows_3"){
       imgEyebrows.src = "/assets/media/CharacterWoman/sample3"+data[5]+".png";
       ctxEyebrows.drawImage(imgEyebrows, 0, 0);
     }else if(data[4]=="eyebrows_4"){
       imgEyebrows.src = "/assets/media/CharacterWoman/sample4"+data[5]+".png";
       ctxEyebrows.drawImage(imgEyebrows, 0, 0);
     }else if(data[4]=="eyebrows_5"){
       imgEyebrows.src = "/assets/media/CharacterWoman/sample5"+data[5]+".png";
       ctxEyebrows.drawImage(imgEyebrows, 0, 0);
     }else if(data[4]=="eyebrows_6"){
       imgEyebrows.src = "/assets/media/CharacterWoman/sample6"+data[5]+".png";
       ctxEyebrows.drawImage(imgEyebrows, 0, 0);
     }
           ...
           let imgEye = new Image();
           if(data[6]=="eye_1"){
             imgEye.src = "/assets/media/CharacterWoman/sample1"+data[7]+".png";
             ctxEye.drawImage(imgEye, 0, 0);
           }else if(data[6]=="eye_2"){
             imgEye.src = "/assets/media/CharacterWoman/sample2"+data[7]+".png";
             ctxEye.drawImage(imgEye, 0, 0);
           }else if(data[6]=="eye_3"){
             imgEye.src = "/assets/media/CharacterWoman/sample3"+data[7]+".png";
             ctxEye.drawImage(imgEye, 0, 0);
           }else if(data[6]=="eye_4"){
             imgEye.src = "/assets/media/CharacterWoman/sample4"+data[7]+".png";
             ctxEye.drawImage(imgEye, 0, 0);
           }else if(data[6]=="eye_5"){
             imgEye.src = "/assets/media/CharacterWoman/sample5"+data[7]+".png";
             ctxEye.drawImage(imgEye, 0, 0);
           }else if(data[6]=="eye_6"){
             imgEye.src = "/assets/media/CharacterWoman/sample6"+data[7]+".png";
             ctxEye.drawImage(imgEye, 0, 0);
           }else if(data[6]=="eye_7"){
            imgEye.src = "/assets/media/CharacterWoman/sample7"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }else if(data[6]=="eye_8"){
            imgEye.src = "/assets/media/CharacterWoman/sample8"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }
          else if(data[6]=="eye_9"){
            imgEye.src = "/assets/media/CharacterWoman/sample9"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }
          else if(data[6]=="eye_10"){
            imgEye.src = "/assets/media/CharacterWoman/sample10"+data[7]+".png";
            ctxEye.drawImage(imgEye, 0, 0);
          }
          ...
          let ctxMouth= canvas.getContext("2d");
          let imgMouth= new Image();
          imgMouth.src = "/assets/media/CharacterWoman/sample"+data[8]+".png";
          ctxMouth.drawImage(imgMouth, 0, 0);
           ...
           let ctxAcc= canvas.getContext("2d");
           let imgAcc= new Image();
           imgAcc.src = "/assets/media/CharacterWoman/sample"+data[11]+".png";
           ctxAcc.drawImage(imgAcc, 0, 0);
    ...
    let imgShoes = new Image();
    if(data[17]=="shoes_1"){
      imgShoes.src = "/assets/media/CharacterWoman/sample1"+data[18]+".png";
      ctxShoes.drawImage(imgShoes, 0, 0);
    }else if(data[17]=="shoes_2"){
      imgShoes.src = "/assets/media/CharacterWoman/sample2"+data[18]+".png";
      ctxShoes.drawImage(imgShoes, 0, 0);
    }else if(data[17]=="shoes_3"){
      imgShoes.src = "/assets/media/CharacterWoman/sample3"+data[18]+".png";
      ctxShoes.drawImage(imgShoes, 0, 0);
    }
          ...
          let imgPant = new Image();
          if(data[15]=="pant_1"){
            imgPant.src = "/assets/media/CharacterWoman/sample1"+data[16]+".png";
            ctxPant.drawImage(imgPant, 0, 0);
          }else if(data[15]=="pant_2"){
            imgPant.src = "/assets/media/CharacterWoman/sample2"+data[16]+".png";
            ctxPant.drawImage(imgPant, 0, 0);
          }else if(data[15]=="pant_3"){
            imgPant.src = "/assets/media/CharacterWoman/sample3"+data[16]+".png";
            ctxPant.drawImage(imgPant, 0, 0);
          }else if(data[15]=="pant_4"){
            imgPant.src = "/assets/media/CharacterWoman/sample4"+data[16]+".png";
            ctxPant.drawImage(imgPant, 0, 0);
          }else if(data[15]=="pant_5"){
            imgPant.src = "/assets/media/CharacterWoman/sample5"+data[16]+".png";
            ctxPant.drawImage(imgPant, 0, 0);
          }  
           ...
           let imgShirt = new Image();
           if(data[12]=="shirt_1"){
             imgShirt.src = "/assets/media/CharacterWoman/sample1"+data[13]+".png";
             ctxShirt.drawImage(imgShirt, 0, 0);
           }else if(data[12]=="shirt_2"){
             imgShirt.src = "/assets/media/CharacterWoman/sample2"+data[13]+".png";
             ctxShirt.drawImage(imgShirt, 0, 0);
           }else if(data[12]=="shirt_3"){
             imgShirt.src = "/assets/media/CharacterWoman/sample3"+data[13]+".png";
             ctxShirt.drawImage(imgShirt, 0, 0);
           }else if(data[12]=="shirt_4"){
             imgShirt.src = "/assets/media/CharacterWoman/sample4"+data[13]+".png";
             ctxShirt.drawImage(imgShirt, 0, 0);
           }else if(data[12]=="shirt_5"){
             imgShirt.src = "/assets/media/CharacterWoman/sample5"+data[13]+".png";
             ctxShirt.drawImage(imgShirt, 0, 0);
           }else if(data[12]=="shirt_6"){
             imgShirt.src = "/assets/media/CharacterWoman/sample6"+data[13]+".png";
             ctxShirt.drawImage(imgShirt, 0, 0);
           }
           ...
           let imgPrint = new Image();
             ...
             imgPrint.src = "/assets/media/CharacterWoman/sample1"+data[14]+".png";
             ctxPrint.drawImage(imgPrint, 0, 0);
          ...
          let imgHair = new Image();
          if(data[9]=="hair_1"){
            imgHair.src = "/assets/media/CharacterWoman/sample1hairC_1.gif";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_2"){
            imgHair.src = "/assets/media/CharacterWoman/sample2"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_3"){
            imgHair.src = "/assets/media/CharacterWoman/sample3"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_4"){
            imgHair.src = "/assets/media/CharacterWoman/sample4"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_5"){
            imgHair.src = "/assets/media/CharacterWoman/sample5"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_6"){
            imgHair.src = "/assets/media/CharacterWoman/sample6"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_7"){
            imgHair.src = "/assets/media/CharacterWoman/sample7"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_8"){
            imgHair.src = "/assets/media/CharacterWoman/sample8"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_9"){
            imgHair.src = "/assets/media/CharacterWoman/sample9"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_10"){
            imgHair.src = "/assets/media/CharacterWoman/sample10"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_11"){
            imgHair.src = "/assets/media/CharacterWoman/sample11"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_12"){
            imgHair.src = "/assets/media/CharacterWoman/sample12"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_13"){
            imgHair.src = "/assets/media/CharacterWoman/sample13"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_14"){
            imgHair.src = "/assets/media/CharacterWoman/sample14"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }else if(data[9]=="hair_15"){
            imgHair.src = "/assets/media/CharacterWoman/sample15"+data[10]+".png";
            ctxHair.drawImage(imgHair, 0, 0);
          }
  ...
  //trigger de la decarga del canvas -  Canvas download trigger
  ...
  OutputProcessor: function(encodedData, svgElement) {
      ...
      return {
          ...
          downloadPng: function(filename, idx) {
              //filename = filename || 'image.png';
              filename = filename || `Research Study ucsb ` + `image.png`;
              if (isPng()) {
